...
class ControladorVentas {
	...
	static public function ctrCrearVenta(){
		...
		if ( isset($_POST["nuevaVenta"]) ) {
			...
			/*----------  ACTUALIZAR COMPRAS DEL CLIENTE, REDUCIR STOCK Y AUMENTAR VENTAS DE LOS PRODUCTOS  ----------*/
	...
	static public function ctrEditarVenta(){
		...
		if ( isset($_POST["editarVenta"]) ) {
			...
			/*----------  FORMATEAR TABLAS DE VENTAS Y DE CLIENTES  ----------*/
			$tabla = "ventas";
			...
			if ($cambioProducto) {
				...
				$productos = json_decode($traerVenta["listaProductos"], true);
				...
				if ( $respuesta == "ok" ) {
					...
					echo '<script>
									...
									swal({
										...
										type: "error",
										title: "Error",
										text: "No se ha podido eliminar la venta, intenta de nuevo."
										showConfirmButton: true,
										confirmButtonText: "Cerrar"
